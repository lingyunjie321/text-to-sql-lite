...
flowchart TD
    ...
    ReflectError -- fix_sql --> FixSQL["reflection_fix\nFixSQLNode"]
    ReflectError -- reasoning_rewrite --> RewriteSQL["reasoning_rewrite\nReasoningRewriteNode"]
    ReflectError -- attempts_exhausted --> HITL["hitl\nHITLNode"]
    ReflectError -- hitl_required --> HITL
    FixSQL -- fix_complete --> ValidateSQL
    RewriteSQL -- rewrite_complete --> ValidateSQL
    HITL -- hitl_required --> FinalizeReview["finalization\nneeds_human_review"]
```
